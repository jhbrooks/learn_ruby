...
describe "#translate" do
  ...
  it "retains punctuation" do
    s = translate("who, me? madness. madness!")
    expect(s).to eq("owhay, emay? adnessmay. adnessmay!")
  end

  it "preserves capitalization status on transformed words" do
    s = translate("What happened to George the Bruce?")
  ...
  it "leaves words containing nothing but consonants alone" do
    s = translate("Nnngh X?")
